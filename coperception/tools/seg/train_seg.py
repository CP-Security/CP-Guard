...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-d",
        "--data",
        default="../../../datasets/V2X-Sim-seg/train",
        type=str,
    ...
    parser.add_argument("--com", default="lowerbound", type=str, help="lowerbound/upperbound/disco/when2com/v2v/sum/mean/max/cat/agent")
